...
Exceptions = {
  ...
  "MetamodelTerms" => ["AllowedRange", "Constraint", "ContextNote", "Derivation", "Fact", "FactType", "Instance", "Join", "ParamValue", "Reading", "Role", "RoleRef", "RoleSequence", "RoleValue", "SetComparisonRoles", "Synonym", "Term", "Unit", "ValueRestriction"],
