...
CREATE TABLE FactRole (
	...
	CONSTRAINT PK_FactRole PRIMARY KEY (
			FactID,
			RoleID
		)
)
...
ALTER TABLE ConceptType ADD
	CONSTRAINT FK_ConceptType_FactType
		FOREIGN KEY (NestsFactTypeID)
		REFERENCES FactType (FactTypeID),
	CONSTRAINT FK_ConceptType_Vocabulary
		FOREIGN KEY (VocabularyID)
		REFERENCES Vocabulary (VocabularyID)
GO
...
ALTER TABLE Instance ADD
	CONSTRAINT FK_Instance_ConceptType
		FOREIGN KEY (ConceptTypeID)
		REFERENCES ConceptType (ConceptTypeID),
...
ALTER TABLE Role ADD
	CONSTRAINT FK_Role_FactType
		FOREIGN KEY (FactTypeID)
		REFERENCES FactType (FactTypeID),
	CONSTRAINT FK_Role_ConceptType
		FOREIGN KEY (ConceptTypeID)
		REFERENCES ConceptType (ConceptTypeID),
...
ALTER TABLE SubType ADD
	CONSTRAINT FK_SubType_FactType
		...
		REFERENCES FactType (FactTypeID),
	CONSTRAINT FK_SuperType_ConceptType
		FOREIGN KEY (SuperTypeID)
		REFERENCES ConceptType (ConceptTypeID),
	CONSTRAINT FK_SubType_ConceptType
...
ALTER TABLE ValueType ADD
	CONSTRAINT FK_ValueType_ConceptType
		FOREIGN KEY (ConceptTypeID)
		REFERENCES ConceptType (ConceptTypeID),
	...
	CONSTRAINT FK_ValueType_ValueType
		FOREIGN KEY (SuperTypeID)
		REFERENCES ValueType (ConceptTypeID)
GO
