#
# schema.rb auto-generated using ActiveFacts for SeparateSubtype on 2013-04-16
#

ActiveRecord::Schema.define(:version => 20130416150852) do
  ...
  create_table "vehicle_incidents", :primary_key => :incident_id, :force => true do |t|
    t.integer	"driver_id"
  end
  ...
  unless ENV["EXCLUDE_FKS"]
    ...
    add_foreign_key :vehicle_incidents, :claims, :column => :incident_id, :primary_key => :claim_id, :dependent => :cascade
