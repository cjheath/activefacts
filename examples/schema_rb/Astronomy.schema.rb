#
# schema.rb auto-generated using ActiveFacts for Astronomy on 2015-02-27
#

ActiveRecord::Schema.define(:version => 20150227183506) do
  ...
  unless ENV["EXCLUDE_FKS"]
    add_foreign_key :astronomical_objects, :astronomical_objects, :column => :orbit_center_astronomical_object_id, :primary_key => :astronomical_object_id, :dependent => :cascade
  end
end
