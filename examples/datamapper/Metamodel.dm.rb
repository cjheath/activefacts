...
class Concept
  ...
  property :name, String, :length => 64, :required => true, :key => true	# Concept is called Name
  property :vocabulary_name, String, :length => 64, :required => true, :key => true	# Concept belongs to Vocabulary and Vocabulary is called Name
  property :pronoun, String, :length => 20, :required => false	# maybe Concept uses Pronoun
...
class Constraint
  ...
  property :constraint_id, Serial, :required => true, :key => true	# Constraint has Constraint Id
  property :name, String, :length => 64, :required => false	# maybe Name is of Constraint
  property :enforcement_agent_name, String, :required => false	# maybe Constraint requires Enforcement and maybe Enforcement notifies Agent and Agent has Agent Name
  property :enforcement_code, String, :length => 16, :required => false	# maybe Constraint requires Enforcement and Enforcement has Enforcement Code
  property :vocabulary_name, String, :length => 64, :required => false	# maybe Vocabulary contains Constraint and Vocabulary is called Name
...
class ContextNote
  ...
  property :concept_name, String, :length => 64, :required => false	# maybe Concept has Context Note and Concept is called Name
...
class FactType
  ...
  property :fact_type_id, Serial, :required => true, :key => true	# Fact Type has Fact Type Id
  property :entity_type_vocabulary_name, String, :length => 64, :required => false	# maybe Entity Type nests Fact Type and Concept belongs to Vocabulary and Vocabulary is called Name
  property :entity_type_name, String, :length => 64, :required => false	# maybe Entity Type nests Fact Type and Concept is called Name
...
class Instance
  ...
  property :population_vocabulary_name, String, :length => 64, :required => false	# Population includes Instance and maybe Vocabulary includes Population and Vocabulary is called Name
...
class ParamValue
  ...
  property :value_type_vocabulary_name, String, :length => 64, :required => true, :key => true	# Param Value is where Value for Parameter applies to Value Type and Concept belongs to Vocabulary and Vocabulary is called Name
  property :value_type_name, String, :length => 64, :required => true, :key => true	# Param Value is where Value for Parameter applies to Value Type and Concept is called Name
...
class PresenceConstraint < Constraint
  property :max_frequency, Integer, :required => false	# maybe Presence Constraint has max-Frequency
...
class RoleRef
  ...
  property :trailing_adjective, String, :length => 64, :required => false	# maybe Role Ref has trailing-Adjective
end

class RoleSequence
  include DataMapper::Resource

  property :role_sequence_id, Serial, :required => true, :key => true	# Role Sequence has Role Sequence Id
...
class Shape
  ...
  property :shape_id, Serial, :required => true, :key => true	# Shape has Shape Id
  property :position_x, Integer, :required => false	# maybe Shape is at Position and Position is at X
  property :position_y, Integer, :required => false	# maybe Shape is at Position and Position is at Y
...
class TypeInheritance < FactType
  property :subtype_vocabulary_name, String, :length => 64, :required => true, :key => true	# Type Inheritance is where Entity Type (as Subtype) is subtype of super-Entity Type (as Supertype) and Concept belongs to Vocabulary and Vocabulary is called Name
  property :subtype_name, String, :length => 64, :required => true, :key => true	# Type Inheritance is where Entity Type (as Subtype) is subtype of super-Entity Type (as Supertype) and Concept is called Name
  ...
  property :supertype_vocabulary_name, String, :length => 64, :required => true, :key => true	# Type Inheritance is where Entity Type (as Subtype) is subtype of super-Entity Type (as Supertype) and Concept belongs to Vocabulary and Vocabulary is called Name
  property :supertype_name, String, :length => 64, :required => true, :key => true	# Type Inheritance is where Entity Type (as Subtype) is subtype of super-Entity Type (as Supertype) and Concept is called Name
  ...
  property :assimilation, String, :required => false	# maybe Assimilation applies to Type Inheritance
...
class Unit
  ...
  property :unit_id, Serial, :required => true, :key => true	# Unit has Unit Id
  property :ephemera_url, String, :required => false	# maybe Ephemera URL provides Unit coefficient
  property :name, String, :length => 64, :required => true	# Name is of Unit
  property :coefficient_numerator, Decimal, :required => false	# maybe Unit has Coefficient and Coefficient has Numerator
  property :coefficient_denominator, Integer, :required => false	# maybe Unit has Coefficient and Coefficient has Denominator
  property :coefficient_is_precise, Boolean, :required => false	# maybe Unit has Coefficient and Coefficient is precise
  property :offset, Decimal, :required => false	# maybe Unit has Offset
  property :plural_name, String, :length => 64, :required => false	# maybe Unit has plural-Name
