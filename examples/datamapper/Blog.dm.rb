...
class Author
  ...
  property :author_id, Serial, :required => true, :key => true	# Author has Author Id
...
class Comment
  ...
  property :comment_id, Serial, :required => true, :key => true	# Comment has Comment Id
  property :author_id, Serial, :required => true	# Author wrote Comment and Author has Author Id
  belongs_to :author	# Author wrote Comment
  property :content_style, String, :length => 20, :required => false	# Content provides text of Comment and maybe Content is of Style
  property :content_text, Text, :required => true	# Content provides text of Comment and Content has Text
  property :paragraph_post_id, Serial, :required => true	# Paragraph has Comment and Paragraph is where Post includes Ordinal paragraph and Post has Post Id
...
class Post
  ...
  property :post_id, Serial, :required => true, :key => true	# Post has Post Id
  property :author_id, Serial, :required => true	# Post was written by Author and Author has Author Id
  belongs_to :author	# Post was written by Author
  property :topic_id, Serial, :required => true	# Post belongs to Topic and Topic has Topic Id
...
class Topic
  ...
  property :topic_id, Serial, :required => true, :key => true	# Topic has Topic Id
  property :parent_topic_id, Serial, :required => false	# maybe Topic belongs to parent-Topic and Topic has Topic Id
