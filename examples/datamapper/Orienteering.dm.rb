...
class Club
  ...
  property :club_code, String, :length => 6, :required => true, :key => true	# Club has Club Code
...
class Entry
  ...
  property :person_id, Serial, :required => true, :key => true	# Entry is where Person entered Course of Event and Person has Person ID
  belongs_to :person	# Person is involved in Entry
  property :course, String, :length => 16, :required => true, :key => true	# Entry is where Person entered Course of Event
  property :event_id, Serial, :required => true, :key => true	# Entry is where Person entered Course of Event and Event has Event ID
  belongs_to :event	# Event is involved in Entry
  property :entry_id, Serial, :required => true, :key => true	# Entry has Entry ID
  property :score, Integer, :required => false	# maybe Entry received Score
  property :finish_placing, Integer, :required => false	# maybe Entry finished in finish-Placing
...
class Event
  ...
  property :event_name, String, :length => 50, :required => false	# maybe Event is called Event Name
...
class Map
  ...
  property :map_id, Serial, :required => true, :key => true	# Map has Map ID
  ...
  property :accessibility, String, :length => 1, :required => false	# maybe Map has Accessibility
...
class Person
  ...
  property :club_code, String, :length => 6, :required => false	# maybe Person is member of Club and Club has Club Code
  ...
  property :post_code, Integer, :required => false	# maybe Person has Post Code
  property :birth_year, Integer, :required => false	# maybe Person was born in birth-Year
  has n, :entry	# Person entered Course of Event
end
...
class Punch
  ...
  property :punch_id, Serial, :required => true, :key => true	# Punch has Punch ID
...
class Series
  ...
  property :series_id, Serial, :required => true, :key => true	# Series has Series ID
