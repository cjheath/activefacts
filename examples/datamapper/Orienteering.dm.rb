...
class EventControl
  ...
  has n, :punch_placement, 'PunchPlacement', :child_key => [:event_control_event_id, :event_control_number], :parent_key => [:event_id, :control_number]	# Punch_Placement is involved in Event Control
end
...
class PunchPlacement
  ...
  belongs_to :event_control, 'EventControl', :child_key => [:event_control_event_id, :event_control_number], :parent_key => [:event_id, :control_number]	# Event_Control is involved in Punch Placement
