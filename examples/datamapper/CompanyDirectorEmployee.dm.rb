...
class Attendance
  ...
  property :meeting_company_name, String, :length => 48, :key => true	# Attendance is where Person attended Meeting and Meeting is held by Company and Company is called Company Name
  ...
  belongs_to :attendee, 'Person', :child_key => [:attendee_given_name, :attendee_family_name], :parent_key => [:given_name, :family_name]	# Attendee is involved in Attendance
end
...
class Company
  ...
  has n, :meeting	# Meeting is held by Company
end
...
class Meeting
  ...
  property :company_name, String, :length => 48, :key => true	# Meeting is held by Company and Company is called Company Name
  belongs_to :company	# Meeting is held by Company
