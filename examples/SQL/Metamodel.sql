...
CREATE TABLE Shape (
	...
	-- maybe ObjectTypeShape is a kind of Shape and ObjectTypeShape is for Concept and Concept is called Name,
	ObjectTypeShapeConceptName              varchar(64) NULL,
	-- maybe ObjectTypeShape is a kind of Shape and ObjectTypeShape is for Concept and Concept belongs to Vocabulary and Vocabulary is called Name,
