...
CREATE TABLE Claim (
	...
	-- Claim is on Policy and Policy is for product having p_product and Product has Product Code,
	PolicyPProductCode                      tinyint NOT NULL,
	-- Claim is on Policy and Policy has p_serial,
	PolicyPSerial                           int NOT NULL,
	-- Claim is on Policy and Policy issued in state having p_state and State has State Code,
	PolicyPStateCode                        tinyint NOT NULL,
	-- Claim is on Policy and Policy was issued in p_year and Year has Year Nr,
...
CREATE TABLE Cover (
	...
	-- Cover is where Policy provides Cover Type over Asset and Policy is for product having p_product and Product has Product Code,
	PolicyPProductCode                      tinyint NOT NULL,
	-- Cover is where Policy provides Cover Type over Asset and Policy has p_serial,
	PolicyPSerial                           int NOT NULL,
	-- Cover is where Policy provides Cover Type over Asset and Policy issued in state having p_state and State has State Code,
	PolicyPStateCode                        tinyint NOT NULL,
	-- Cover is where Policy provides Cover Type over Asset and Policy was issued in p_year and Year has Year Nr,
	PolicyPYearNr                           int NOT NULL,
...
CREATE TABLE VehicleIncident (
	...
	-- maybe Driving is where Vehicle Incident involves Driver and maybe driver_hospitalised resulted in driver taken to hospital-Name,
