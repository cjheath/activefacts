CREATE TABLE Asset (
	...
	-- maybe Vehicle is a subtype of Asset and Vehicle is of model-Year restricted to {1900..2100} and Year has YearNr,
...
CREATE TABLE Party (
	...
	-- maybe Person is a subtype of Party and maybe Driver is a subtype of Person and maybe Driver holds License and maybe License was granted in Year restricted to {1990..2100} and Year has YearNr,
