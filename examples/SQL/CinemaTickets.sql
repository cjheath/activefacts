CREATE TABLE AllocatableCinemaSection (
	-- AllocatableCinemaSection (in which Cinema provides allocated seating in Section) and Cinema has Cinema ID,
	CinemaID                                int NOT NULL,
	-- AllocatableCinemaSection (in which Cinema provides allocated seating in Section) and Section has Section Name,
...
CREATE TABLE Booking (
	...
	-- Booking (in which Person booked Session for Number of places) involves Number,
	Number                                  smallint NOT NULL CHECK(Number >= 1),
	-- Booking (in which Person booked Session for Number of places) and Person has Person ID,
	PersonID                                int NOT NULL,
	-- maybe Booking is for seats in Section and Section has Section Name,
	SectionName                             varchar NULL,
	-- Booking (in which Person booked Session for Number of places) and Session (in which Cinema shows Film on Session Time) and Cinema has Cinema ID,
	SessionCinemaID                         int NOT NULL,
	-- Booking (in which Person booked Session for Number of places) and Session (in which Cinema shows Film on Session Time) and Session Time is on Day,
	SessionTimeDay                          int NOT NULL,
	-- Booking (in which Person booked Session for Number of places) and Session (in which Cinema shows Film on Session Time) and Session Time is at Hour,
	SessionTimeHour                         int NOT NULL,
	-- Booking (in which Person booked Session for Number of places) and Session (in which Cinema shows Film on Session Time) and Session Time is at Minute,
	SessionTimeMinute                       int NOT NULL,
	-- Booking (in which Person booked Session for Number of places) and Session (in which Cinema shows Film on Session Time) and Session Time is in Month and Month has Month Nr,
	SessionTimeMonthNr                      int NOT NULL,
	-- Booking (in which Person booked Session for Number of places) and Session (in which Cinema shows Film on Session Time) and Session Time is in Year and Year has Year Nr,
...
CREATE TABLE PlacesPaid (
	-- Places Paid (in which Number of places for Booking have been paid for by Payment Method) and Booking has Booking Nr,
	BookingNr                               int NOT NULL,
	-- Places Paid (in which Number of places for Booking have been paid for by Payment Method) involves Number,
	Number                                  smallint NOT NULL CHECK(Number >= 1),
	-- Places Paid (in which Number of places for Booking have been paid for by Payment Method) and Payment Method has Payment Method Code,
...
CREATE TABLE SeatAllocation (
	...
	-- Seat Allocation (in which Booking has allocated-Seat) and Booking has Booking Nr,
	BookingNr                               int NOT NULL,
...
CREATE TABLE Session (
	-- Session (in which Cinema shows Film on Session Time) and Cinema has Cinema ID,
	CinemaID                                int NOT NULL,
	-- Session (in which Cinema shows Film on Session Time) and Film has Film ID,
	FilmID                                  int NOT NULL,
	-- Session is high-demand,
	IsHighDemand                            bit NULL,
	-- Session (in which Cinema shows Film on Session Time) and Session Time is on Day,
	SessionTimeDay                          int NOT NULL CHECK((SessionTimeDay >= 1 AND SessionTimeDay <= 31)),
	-- Session (in which Cinema shows Film on Session Time) and Session Time is at Hour,
	SessionTimeHour                         int NOT NULL CHECK((SessionTimeHour >= 0 AND SessionTimeHour <= 23)),
	-- Session (in which Cinema shows Film on Session Time) and Session Time is at Minute,
	SessionTimeMinute                       int NOT NULL CHECK((SessionTimeMinute >= 0 AND SessionTimeMinute <= 59)),
	-- Session (in which Cinema shows Film on Session Time) and Session Time is in Month and Month has Month Nr,
	SessionTimeMonthNr                      int NOT NULL CHECK((SessionTimeMonthNr >= 1 AND SessionTimeMonthNr <= 12)),
	-- Session (in which Cinema shows Film on Session Time) and Session Time is in Year and Year has Year Nr,
...
CREATE TABLE TicketPricing (
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Cinema has Cinema ID,
	CinemaID                                int NOT NULL,
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) involves High Demand,
	HighDemand                              Boolean NOT NULL,
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) involves Price,
	Price                                   decimal NOT NULL,
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Section has Section Name,
	SectionName                             varchar NOT NULL,
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Session Time is on Day,
	SessionTimeDay                          int NOT NULL CHECK((SessionTimeDay >= 1 AND SessionTimeDay <= 31)),
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Session Time is at Hour,
	SessionTimeHour                         int NOT NULL CHECK((SessionTimeHour >= 0 AND SessionTimeHour <= 23)),
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Session Time is at Minute,
	SessionTimeMinute                       int NOT NULL CHECK((SessionTimeMinute >= 0 AND SessionTimeMinute <= 59)),
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Session Time is in Month and Month has Month Nr,
	SessionTimeMonthNr                      int NOT NULL CHECK((SessionTimeMonthNr >= 1 AND SessionTimeMonthNr <= 12)),
	-- Ticket Pricing (in which tickets on Session Time at Cinema in Section for High Demand have Price) and Session Time is in Year and Year has Year Nr,
	SessionTimeYearNr                       int NOT NULL CHECK((SessionTimeYearNr >= 1900 AND SessionTimeYearNr <= 9999)),
