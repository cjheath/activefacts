...
CREATE TABLE ProductionForecast (
	...
	Cost                                    decimal NULL,
	-- Production Forecast is where Refinery will make Quantity of Product in Supply Period and Product has Product Name,
	ProductName                             varchar NOT NULL,
	-- Production Forecast is where Refinery will make Quantity of Product in Supply Period,
	Quantity                                int NOT NULL,
	-- Production Forecast is where Refinery will make Quantity of Product in Supply Period and Refinery has Refinery Name,
	RefineryName                            varchar(80) NOT NULL,
	-- Production Forecast is where Refinery will make Quantity of Product in Supply Period and Supply Period is in Month and Month has Month Nr,
	SupplyPeriodMonthNr                     int NOT NULL CHECK((SupplyPeriodMonthNr >= 1 AND SupplyPeriodMonthNr <= 12)),
	-- Production Forecast is where Refinery will make Quantity of Product in Supply Period and Supply Period is in Year and Year has Year Nr,
...
CREATE TABLE RegionalDemand (
	-- Regional Demand is where Region will need Quantity of Product in Supply Period and Product has Product Name,
	ProductName                             varchar NOT NULL,
	-- Regional Demand is where Region will need Quantity of Product in Supply Period,
	Quantity                                int NOT NULL,
	-- Regional Demand is where Region will need Quantity of Product in Supply Period and Region has Region Name,
	RegionName                              varchar NOT NULL,
	-- Regional Demand is where Region will need Quantity of Product in Supply Period and Supply Period is in Month and Month has Month Nr,
	SupplyPeriodMonthNr                     int NOT NULL CHECK((SupplyPeriodMonthNr >= 1 AND SupplyPeriodMonthNr <= 12)),
	-- Regional Demand is where Region will need Quantity of Product in Supply Period and Supply Period is in Year and Year has Year Nr,
	SupplyPeriodYearNr                      int NOT NULL,
