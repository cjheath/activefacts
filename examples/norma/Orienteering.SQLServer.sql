...
ALTER TABLE Orienteering.Person ADD CONSTRAINT Person_FK FOREIGN KEY (memberOfClub) REFERENCES Orienteering.Club (clubCode) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
...
ALTER TABLE Orienteering.ControlValue ADD CONSTRAINT ControlValue_FK FOREIGN KEY (EventID) REFERENCES Orienteering.Event (EventID) ON DELETE NO ACTION ON UPDATE NO ACTION
GO


ALTER TABLE Orienteering.PunchPlacement ADD CONSTRAINT PunchPlacement_FK FOREIGN KEY (EventID) REFERENCES Orienteering.Event (EventID) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
